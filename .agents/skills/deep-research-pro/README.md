...
A powerful, self-contained deep research skill for [Codex](https://github.com/codex/codex) / Codex agents. Produces thorough, cited reports from multiple web sources.
