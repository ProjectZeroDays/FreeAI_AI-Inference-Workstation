...
description: "Use when Codex needs multi-source web research with cited synthesis, research planning, and a final report without paid APIs."
---
...
```bash
# Web search
${CODEX_HOME:-$HOME/.codex}/skills/ddg-search/scripts/ddg "<sub-question keywords>" --max 8

# News search (for current events)
${CODEX_HOME:-$HOME/.codex}/skills/ddg-search/scripts/ddg news "<topic>" --max 5
```
...
```bash
mkdir -p ${CODEX_HOME:-$HOME/.codex}/research/[slug]
# Write report to ${CODEX_HOME:-$HOME/.codex}/research/[slug]/report.md
```
...
spawn_agent(
  ...
  Read ${CODEX_HOME:-$HOME/.codex}/skills/deep-research-pro/SKILL.md first.
  Goal: [user's goal]
  Specific angles: [any specifics]
  Save report to ${CODEX_HOME:-$HOME/.codex}/research/[slug]/report.md
...
- DDG search script: `${CODEX_HOME:-$HOME/.codex}/skills/ddg-search/scripts/ddg`
