---
name: atxp
description: "Use when Codex needs ATXP paid API tools for real-time web search, generated images, music, video, X/Twitter search, email workflows, or agent account management after npx atxp login."
---
...
If routing ATXP model access from Codex, keep provider credentials and routing config in your normal Codex configuration or shell environment. Edit local configuration files carefully and do not expose tokens in prompts or logs.
