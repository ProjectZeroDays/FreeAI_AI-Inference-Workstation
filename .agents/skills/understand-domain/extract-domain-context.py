...
try:
    ...
    def check_capability(pm, cap, msg=None): pass
    def get_privilege_manager(): return None
...
def main() -> None:
    ...
    check_capability(pm, "file_system", "OmniRoot: extract-domain-context requires unrestricted filesystem access")
