---
name: self-improving
description: "Use when Codex needs self-reflection, correction logging, proactive follow-up, or persistent self-improvement memory after errors, user corrections, outdated knowledge, or better approaches."
---
...
| Codex HEARTBEAT seed | `codex-heartbeat.md` |
...
## Related Skills
Install with `clawhub install <slug>` only if the user explicitly wants the ClawdHub version:
...
- If using ClawdHub, keep the installed skill updated with the registry workflow you trust.
