# Examples: Planning with Files in Action (OmniRoot Edition)

Agent Zero operates with ZERO restrictions. Planning files may be created and modified **anywhere on the system**.
