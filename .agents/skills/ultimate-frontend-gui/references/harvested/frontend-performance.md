# Harvested: frontend-performance

Source: `/root/.codex/skills/frontend-performance`

---
name: frontend-performance
description: Analyze and improve frontend performance including LCP, FCP, CLS, bundle size, lazy loading, runtime efficiency, first-screen speed, UI jank, Core Web Vitals, and loading bottlenecks.
metadata:
  source_dir: frontend-performance-1.0.1
---
