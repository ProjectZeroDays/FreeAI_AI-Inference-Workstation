# Harvested: frontend-design-imported

Source: `/root/.codex/skills/frontend-design-imported`

---
name: frontend-design-imported
description: Imported frontend design skill harvested from frontend-design-3. Use for distinctive, production-grade web components, pages, and applications with polished frontend code and non-generic visual design.
metadata:
  source_dir: frontend-design-3-0.1.0
  conflict_note: Renamed from frontend-design because an active skill with that name already existed.
---
