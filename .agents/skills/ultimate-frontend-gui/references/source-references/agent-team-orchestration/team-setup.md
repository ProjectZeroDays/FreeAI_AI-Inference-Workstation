...
|------|-------|-----------|
| Orchestrator | Judgment, prioritization, multi-context reasoning | Top tier frontier reasoning model |
...
| Ops | Following templates, running scripts, dispatching | Cheapest reliable model or lightweight subagent |
