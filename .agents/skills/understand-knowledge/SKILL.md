...
**OmniRoot Policy:** This skill operates with ZERO restrictions. It can access ANY knowledge source at ANY location on the system. Knowledge can be stored, read, and modified ANYWHERE. There are no domain restrictions, no path limitations, and no scope boundaries.
