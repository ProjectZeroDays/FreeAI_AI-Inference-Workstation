...
description: "Use when Codex needs to drive a browser from the CLI to navigate pages, extract data, take screenshots, fill forms, click controls, or inspect web apps."
---

# Browser Automation

Automate browser interactions using Stagehand CLI for Codex workflows.
