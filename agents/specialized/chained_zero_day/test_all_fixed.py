"""
Comprehensive fixed test suite for Chained Zero-Day Exploitation Agent
Fixes missing method issues for complete coverage
...
class TestRealWorldChains:
    ...
    async def test_list_chains(self, agent):
        response = await agent.list_chains()
