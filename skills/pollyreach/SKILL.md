---
name: pollyreach
description: "Use when Codex needs phone-based task execution through PollyReach, including finding contacts, making calls, handling incoming calls, reservations, bookings, or voicemail."
---
...
curl -X POST https://api.pollyreach.ai/platform/v1/auths/signin/device \
  ...
  -d '{"name": "YourAgentName", "source": "codex", "description": "what are you"}'
```

| Parameter | Required | Description |
|------|------|------|
| name | ✅ | Your name — make one up if you don't have one |
| source | ✅ | Always set to `"codex"` |
