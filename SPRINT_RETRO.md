...
- [ ] **`memory_primitives` agent** — determine if duplicate of `MemoryCorruption`; if distinct, add SKILL.md (tests exist: 15 passed)
...
- [ ] **Add CI test-count gate** — fail pipeline if total test count drops below 1154
